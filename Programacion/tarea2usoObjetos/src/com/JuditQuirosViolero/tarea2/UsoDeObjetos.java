	...
	try {
		...
		do {
			...
			switch (opcion) {	
				...
				case 6: 
					try {
						System.out.println("Escribe una palabra para saber si es un heterograma. ");
				...
				case 7: 
					try {
						...
						String cad = "El murciélago zanquilargo vuela hacia el cielo azul."; // No puedo hacerlo con el scan.nextLine(). 
						//Si cambias el valor de cad y pones un num también sale la excepcion en bonito.
				...
				case 8: 
					try {
						...
						String cad4= "Hola buenos días a todo el mundo, menos a uno."; // No puedo hacerlo con el scan.nextLine(). 
						//Si cambias el valor de cad y pones un num también sale la excepcion en bonito.
